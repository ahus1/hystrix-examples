...
=== Ensuring a clean startup and shutdown or Hystrix in your application
...
I recommend a shutdown of Hystrix as it starts several thread pools to do its job. Just add the line
...
As we have also included Archaius as a default to reconfigure our application and Hystrix, we should shutdown this as well.
